...
def discriminator(x, txt, img_height, img_width, img_depth=3, df_dim=64, is_train=True, reuse=tf.AUTO_REUSE):
    ...
    with tf.variable_scope('Discriminator', reuse=reuse):
        ...
        h1 = Layer.batch_norm(h1, act=tf.nn.leaky_relu, is_train=is_train, gamma_init=gamma_init, name='h1/batch_norm')
        # 2
        ...
        h2 = Layer.batch_norm(h2, act=tf.nn.leaky_relu, is_train=is_train, gamma_init=gamma_init, name='h2/batch_norm')
        # 3
        ...
        h3 = Layer.batch_norm(h3, act=tf.identity, is_train=is_train, gamma_init=gamma_init, name='h3/batch_norm')
        # 4
        ...
        h4 = Layer.batch_norm(h4, act=tf.nn.leaky_relu, is_train=is_train, gamma_init=gamma_init, name='h4/batch_norm')
        # 5
        ...
        h5 = Layer.batch_norm(h5, act=tf.nn.leaky_relu, is_train=is_train, gamma_init=gamma_init, name='h5/batch_norm')
        # 6
        ...
        h6 = Layer.batch_norm(h6, is_train=is_train, gamma_init=gamma_init, name='h6/batch_norm')
        # residual
        ...
        txt_expand = tf.tile(txt_expand, multiples=[1, h6_out.get_shape()[1], h6_out.get_shape()[2],1])
        ...
        h7 = Layer.batch_norm(h7, act=tf.nn.leaky_relu, is_train=is_train, gamma_init=gamma_init, name='h7/batch_norm')
